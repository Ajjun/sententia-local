...
@Component({
  selector: 'app-webfinal',
  templateUrl: './webfinal.component.html',
  styleUrls: ['./webfinal.component.css']
})

export class WebfinalComponent implements OnInit {
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  constructor(private router: Router, private http: HttpClient, public snackBar: MatSnackBar, private idle: Idle) {
...
/*--------------------------------------ngOnInit Starts----------------------------------------------------*/
  ...
  /*----------------------------------------------------------------------------------------------------------------*/
   ...
   for (let i of res) {
      ...
      err => {
         alert("Error occured on loading Line Graph. Please reload the page.")
      });
      this.lineDisplayValue = true;
    }
}
